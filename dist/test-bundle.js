...
},{"type-detect":40}],25:[function(require,module,exports){
/*!
 * chai
...
},{"./lib/type":41,"dup":35}],41:[function(require,module,exports){
/*!
 * type-detect
 * Copyright(c) 2013 jake luer <jake@alogicalparadox.com>
 * MIT Licensed
...
},{}],"test-bundle":[function(require,module,exports){
'use strict';
...
var _TesterProto = {
    ...
    run: function run() {
        ...
        module.exports.write = function (file, content) {
            toWrite = toWrite || {};
            if ((typeof content === 'undefined' ? 'undefined' : _typeof(content)) == 'object') toWrite[file] = JSON.stringify(content);else toWrite[file] = content;
        };

        oldConsoleLog = console.log;
        console.log = function () {
            w('\n     LOG: ' + oldConsoleLog.apply(undefined, arguments));
        };
        ...
        _tests.forEach(function (item) {
            ...
            try {
                ...
                var stack = console.$stackTrace(e).replace(/ -- /g, '\n     ');
                if (stack) estr += '\n     STACK:\n     ' + stack;
                w('\n     Error.' + estr + '\n');
                failed = true;
            }
...
},{"chai":4,"netsuite-console-log":39}]},{},["test-bundle"]);

GLOBALS['test_bundle'] = require('test-bundle');
